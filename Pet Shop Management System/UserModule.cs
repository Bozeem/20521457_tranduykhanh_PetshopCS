...
namespace Pet_Shop_Management_System
{
    public partial class UserModule : Form
    {
        ...
        {
            if(txtName.Text == ""| txtAddress.Text=="" | txtAddress.Text =="" | txtPhone.Text=="" | txtPass.Text=="")
            {
        ...
        private static int checkAGe(DateTime dateofBirth) // ham kiem tra tuoi
        {
        ...
        private void txtPhone_KeyPress(object sender, KeyPressEventArgs e) // chi duoc nhap so thoi
        {
            if (!char.IsControl(e.KeyChar)  && !char.IsDigit(e.KeyChar)) // khac ki tu dieu khien va chuoi
            {
                e.Handled = true;
            }
        }
